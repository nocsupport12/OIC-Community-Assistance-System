...
<main class="flex justify-center items-start p-6 lg:p-10">
  <div class="bg-white/80 backdrop-blur-lg shadow-2xl rounded-3xl w-full max-w-4xl p-8 md:p-10">
    ...
    <?php if (isset($_SESSION['success'])): ?>
      <div id="alertBox" class="bg-green-100 border border-green-300 text-green-700 text-center p-3 rounded-lg mb-6">
    ...
    <form method="POST" enctype="multipart/form-data" class="flex flex-col gap-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div>
          ...
          <select name="role"
            class="w-full border border-gray-300 rounded-lg px-4 py-2.5 bg-white focus:ring-2 focus:ring-green-500 focus:outline-none" required>
