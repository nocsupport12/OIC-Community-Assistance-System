...
<body class="font-sans min-h-screen flex items-center justify-center bg-cover " style="background-image: url('assets/e1.jpg');">
  ...
  <form class="space-y-5" method="POST" action="login.php">
    ...
    <div>
      ...
      <input 
        ...
        class="mt-1 w-full bg-gray-50 border border-[#DDA15E] focus:border-[#DDA15E] focus:ring focus:ring-[#DDA15E] p-3 rounded-xl outline-none"
      />
    </div>
    ...
    <button type="submit" class="w-full py-3 bg-gradient-to-r from-[#BC6C25] to-[#FB8500] text-white rounded-xl font-semibold shadow-lg hover:shadow-none hover:scale-105 transform transition duration-300">
      Login
    </button>
