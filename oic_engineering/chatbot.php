...
<head>
<meta charset="UTF-8">
<title>OIC ENGINEERING – Forms link</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<!-- Font & main style (kept as in your original, plus minimal additions) -->
...
.img1{ width:250px; height:320px; top:110px; left:200px; z-index:1; }
.img2{ width:190px; height:270px; top:40px; left:70px; z-index:1; }
.img3{ width:160px; height:160px; top:340px; left:140px; z-index:2; }
.img4{ width:180px; height:220px; top:200px; left:-10px; z-index:1; }
.img-card:hover{ transform:scale(1.05); }
.bg-slider{ opacity: 0.8; }
...
@media (max-width: 1200px){
    .upper-left-logo img{ width:120px; }
    .upper-left-text{ font-size:18px; }
}
@media (max-width: 768px){
    .upper-left-logo img{ width:100px; }
    .upper-left-text{ font-size:16px; }
}
...
/* ================= CHAT & FOOTER minimal (preserved) ================= */
.chat-glass, .chat-mini, .chat-bubble { /* styles from external CSS – we keep your class names */ }
/* ensure chat body has some spacing */
.chat-body {
    padding: 16px 12px 8px 12px;
}
/* your original <a> inside chat (i kept it but placed dropdown instead) */
.chat-body a { /* optional */ }
...
<!-- BACKGROUND IMAGE -->
<div class="bg-slider">
    <img src="assets/e1.jpg" class="bg active" alt="background">
</div>

<!-- LOGO -->
<header class="logo">
    <div class="upper-left-logo"><img src="assets/logo.png" alt="OIC logo"></div>
    <div class="upper-left-text">ENGINEERING OFFICE</div>
</header>

<!-- LEFT IMAGE COLLAGE -->
<div class="left-collage">
    <div class="img-card img1"><img src="assets/e5.jpg" alt=""></div>
    <div class="img-card img2"><img src="assets/e6.jpg" alt=""></div>
    <div class="img-card img3"><img src="assets/e3.jpg" alt=""></div>
    <div class="img-card img4"><img src="assets/e2.jpg" alt=""></div>
</div>
    ...
    <div class="chat-body" id="chatBody">
        ...
        <div class="forms-dropdown-container">
            <button class="forms-toggle-btn" id="formsToggleBtn" onclick="toggleFormsMenu(event)">
                <span>📋  Engineering Forms</span>
                <span class="arrow">▼</span>
            </button>
            <ul class="forms-menu" id="formsMenu">
                <li><a href="forms/engineering_permit.html" target="_blank">📄 Building Permit</a></li>
                <li><a href="forms/electrical_permit.html" target="_blank">⚡ Electrical Permit</a></li>
                <li><a href="forms/mechanical_permit.html" target="_blank">🔧 Mechanical Permit</a></li>
                <li><a href="forms/plumbing_permit.html" target="_blank">🚰 Plumbing Permit</a></li>
                <li><a href="forms/occupancy_permit.html" target="_blank">🏢 Certificate of Occupancy</a></li>
                <li style="margin-top:10px; border-top:1px solid #3a4c62;"><a href="forms/application_form.pdf" target="_blank">📎 General Application (PDF)</a></li>
            </ul>
        </div>
...
function openChat()     { if(window.openChat) window.openChat(); else {
    // simple fallback to show chat
    document.getElementById('chatBox').style.display = 'block';
    document.getElementById('chatMini').style.display = 'none';
    document.getElementById('chatBubble').style.display = 'none';
} }
function restoreChat()  { if(window.restoreChat) window.restoreChat(); else {
    document.getElementById('chatBox').style.display = 'block';
    document.getElementById('chatMini').style.display = 'none';
    document.getElementById('chatBubble').style.display = 'none';
} }
