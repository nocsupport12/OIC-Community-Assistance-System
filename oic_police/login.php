...
<body class="font-sans min-h-screen flex items-center justify-center bg-cover bg-center bg-black/40" style="background-image: url('assets/carousel1.png');">
...
<div class="md:w-1/2 md:flex items-center ">
  ...
  <p class="text-left text-gray-800 font-bold mb-5 text-xl">Login to your One Intranet Police Account</p>
  ...
  <form class="space-y-5" method="POST" action="login.php">
    ...
    <div>
      ...
      <input 
        ...
        class="mt-1 w-full bg-gray-50 border border-gray-300 focus:border-green-400 focus:ring focus:ring-red-600 p-3 rounded-xl outline-none"
      />
    </div>
    ...
    <p class="text-center"><a href="forgot_password.php" class=" text-s text-red-800 hover:text-green-900 hover:underline">Can't Login?</a></p>
  </form>
</div>
