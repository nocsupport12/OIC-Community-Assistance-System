...
<body class="font-sans min-h-screen flex items-center justify-center bg-cover bg-center bg-black/40" style="background-image: url('assets/assistace.jpg');">
...
<div class="min-h-screen flex items-center justify-center w-cover h-90">
  <div class="flex flex-col md:flex-row 
    ...
    <!-- Left Image Section -->
    <div class="md:w-1/2 flex items-center justify-center bg-white-300 p-6">
    ...
    <!-- Right Form -->
    <div class="md:w-2/3 w-full p-14 flex flex-col bg-">
  ...
  <form class="space-y-5" method="POST" action="login.php">
    ...
    <div>
      ...
      <input 
        ...
        type="password" 
        placeholder="********" 
        requigreen autocomplete="current-password"
        class="mt-1 w-full bg-gray-50 border border-gray-300 focus:border-green-400 focus:ring focus:ring-green-600 p-3 rounded-xl outline-none"
      />
    </div>
