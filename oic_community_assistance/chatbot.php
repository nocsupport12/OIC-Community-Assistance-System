...
<!-- BACKGROUND CAROUSEL -->
<div class="bg-slider">
    <img src="assets/assistace.jpg" class="bg active">
</div>

<!-- LOGO -->
<header class="logo">
    <div class="upper-left-logo"><img src="assets/logo.png"></div>
    <div class="upper-left-text">COMMUNITY ASSISTANCE</div>
</header>

<!-- LEFT IMAGE COLLAGE -->
<div class="left-collage">
    <div class="img-card img1"><img src="assets/assistace1.jpg"></div>
    <div class="img-card img2"><img src="assets/assistace2.jpg"></div>
    <div class="img-card img3"><img src="assets/assistace3.jpg"></div>
    <div class="img-card img4"><img src="assets/assistace4.jpg"></div>
</div>
