...
<head>
  ...
  <style>
    ...
    * {
    ...
    body {
      background: linear-gradient(135deg, #6bc754 0%, #6bc754 100%);
    ...
    /* Welcome banner */
    .welcome-banner {
      background: linear-gradient(135deg, #74af77 0%, #b9c275 100%);
      border-radius: 16px;
      padding: 1.5rem 2rem;
      color: white;
      margin-bottom: 2rem;
...
<body>
  <div class="main-content">
    ...
    <div class="welcome-banner">
      <div>
        <h1 class="text-2xl md:text-3xl font-bold mb-1 text-black">Query Analytics Dashboard</h1>
        <p class="text-black/80 text-sm">Welcome, <?= htmlspecialchars(explode(' ', $staffName)[0]) ?>! Track all customer inquiries</p>
      </div>
