...
<head>
  ...
  <style>
    ...
    * {
    ...
    body {
      background: linear-gradient(135deg, #3a2317 0%, #b07154 100%);
...
<body>
  <div class="main-content">
    ...
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between mb-8">
      <div>
        <h1 class="text-3xl md:text-4xl font-bold text-white mb-2">Dashboard Overview</h1>
        <p class="text-white/80 text-sm">Welcome back! Here's what's happening with your queries.</p>
      </div>
