...
<main class="flex justify-center items-start p-6 lg:p-10">
  <div class="bg-white/80 backdrop-blur-lg shadow-2xl rounded-3xl w-full max-w-4xl p-8 md:p-10">
    ...
    <?php if (isset($_SESSION['success'])): ?>
      <div id="alertBox" class="bg-orange-100 border border-orange-300 text-orange-700 text-center p-3 rounded-lg mb-6">
    ...
    <form method="POST" enctype="multipart/form-data" class="flex flex-col gap-8">
      ...
      <div class="flex flex-col items-center">
        <div class="relative">
          <img id="profilePreview"
            ...
            class="w-36 h-36 rounded-full object-cover border-4 border-orange-500 shadow-md transition-all duration-200 hover:scale-105"
          />
          <label for="profile" class="absolute bottom-2 right-2 bg-orange-600 text-white p-2 rounded-full cursor-pointer hover:bg-orange-700 transition">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div>
          ...
          <input type="text" name="fname"
            class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-orange-500 focus:outline-none" required />
        </div>

        <div>
          <label class="text-sm text-gray-600">Middle Name</label>
          <input type="text" name="mnane"
            class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-orange-500 focus:outline-none" />
        </div>
        ...
        <div>
          ...
          <select name="role"
            class="w-full border border-gray-300 rounded-lg px-4 py-2.5 bg-white focus:ring-2 focus:ring-orange-500 focus:outline-none" required>
      ...
      <div class="flex justify-center mt-6">
        <button id="saveBtn" type="submit"
          class="bg-orange-600 text-white px-6 py-2.5 rounded-lg hover:bg-orange-700 transition flex items-center gap-2">
