...
<!-- BACKGROUND IMAGE -->
<div class="bg-slider">
    <img src="assets/ac5.png" class="bg active">
</div>

<!-- LOGO -->
<header class="logo">
    <div class="upper-left-logo"><img src="assets/logo.png"></div>
    <div class="upper-left-text">ACCOUNTING OFFICE</div>
</header>

<!-- LEFT IMAGE COLLAGE -->
<div class="left-collage">
    <div class="img-card img1"><img src="assets/ac4.png"></div> <!-- largest image -->
    <div class="img-card img2"><img src="assets/ac1.png"></div> <!-- top image -->
    <div class="img-card img3"><img src="assets/ac2.png"></div> <!-- smallest image -->
    <div class="img-card img4"><img src="assets/ac3.png"></div> <!-- left image -->
</div>
...
<!-- FOOTER -->
<footer class="site-footer" color: >
