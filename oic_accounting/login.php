...
<title>OIC Login - Accounting Office</title>
<script src="https://cdn.tailwindcss.com"></script>
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css"/>
</head>

<body class="font-sans min-h-screen flex items-center justify-center bg-cover " style="background-image: url('assets/ac5.png');">
...
<div class="md:w-1/2 md:flex items-center ">
  ...
  <form class="space-y-5" method="POST" action="login.php">
    <?php if(!empty($error_message)): ?>
      <p class="text-black-500 text-center bg-gray-100 p-3 rounded-md border border-gray-200 font-medium"><?= htmlspecialchars($error_message) ?></p>
    <?php endif; ?>
    ...
    <div>
      ...
      <input 
        ...
        class="mt-1 w-full bg-gray-50 border border-gray-300 focus:border-gray-400 focus:ring focus:ring-gray-600 p-3 rounded-xl outline-none"
      />
    </div>
    ...
    <button type="submit" class="w-full py-3 bg-gradient-to-r from-gray-900 to-gray-500 text-white rounded-xl font-semibold shadow-lg hover:shadow-none hover:scale-105 transform transition duration-300">
      Login
    </button>
