...
<nav class="bg-white border-b border-gray-200">
    ...
    <div class="flex justify-between h-16 items-center">
      ...
      <div class="flex items-center">
        <a href="index.php" class="flex-shrink-0 flex items-center">
          <img src="../assets/Logo.png" class="block h-20 w-auto" alt="Logo">
        </a>
        ...
        <div class="hidden sm:flex sm:space-x-8 sm:ml-10">
          ...
          <a href="archived.php" class="text-gray-700 hover:text-blue-600 font-medium">Archive</a>
          <a href="knowledge_admin.php" class="text-gray-700 hover:text-blue-600 font-medium">Edit Ai</a>
          <a href="ai_usage_dashboard.php" class="text-gray-700 hover:text-blue-600 font-medium">AI_USAGE</a>
  ...
  <div id="mobileMenu" class="hidden sm:hidden border-t border-gray-200 bg-white">
    <div class="px-4 pt-4 pb-3 space-y-3">
      ...
      <a href="archived.php" class="block text-gray-700 hover:text-blue-600 font-medium">Archive</a>
      <hr>
      <a href="profile.php" class="block text-gray-700 hover:text-blue-600 font-medium">Profile</a>
      <a href="staff.php" class="block text-gray-700 hover:text-blue-600 font-medium">Staff</a>
      <a href="users.php" class="block text-gray-700 hover:text-blue-600 font-medium">Users</a>
